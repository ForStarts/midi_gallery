...
program_to_name={
    ...
    26: ["Acoustic Guitar (steel)", "爵士电吉他"],
    ...
    82: ["Lead 3 (calliope lead)", "合成主音3"],
    83: ["Lead 4 (chiff lead)", "合成主音4"],
    84: ["Lead 5 (charang)", "合成主音5"],
    85: ["Lead 6 (voice)", "合成主音6（人声）"],
    86: ["Lead 7 (fifths)", "合成主音7（平行五度）"],
    87: ["Lead 8 (bass + lead)", "合成主音8（贝斯+主音）"],
    88: ["Pad 1 (new age)", "合成音色1（新世纪）"],
    89: ["Pad 2 (warm)", "合成音色2（温暖）"],
    90: ["Pad 3 (polysynth)", "合成音色3（多音）"],
    91: ["Pad 4 (choir)", "合成音色4（合唱）"],
    92: ["Pad 5 (bowed)", "合成音色5"],
    93: ["Pad 6 (metallic)", "合成音色6（金属声）"],
    94: ["Pad 7 (halo)", "合成音色7（光环）"],
    95: ["Pad 8 (sweep)", "合成音色8"],
    96: ["FX 1 (rain)", "合成效果音色1（雨声）"],
    97: ["FX 2 (soundtrack)", "合成效果音色2（音乐）"],
    98: ["FX 3 (crystal)", "合成效果音色3（水晶）"],
    99: ["FX 4 (atmosphere)", "合成效果音色4（大气）"],
    100: ["FX 5 (brightness)", "合成效果音色5（明亮）"],
    101: ["FX 6 (goblins)", "合成效果音色6（鬼魂）"],
    102: ["FX 7 (echoes)", "合成效果音色7（回声）"],
    103: ["FX 8 (sci-fi)", "合成效果音色8（科幻）"],
    104: ["Sitar", "西塔尔（印度）"],
    105: ["Banjo", "班卓琴（美洲）"],
    106: ["Shamisen", "三昧线（日本）"],
    107: ["Koto", "十三弦筝（日本）"],
